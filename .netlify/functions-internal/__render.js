...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-a4c61357.js",
      css: [assets + "/_app/assets/start-464e9d0a.css", assets + "/_app/assets/vendor-8daff541.css"],
      js: [assets + "/_app/start-a4c61357.js", assets + "/_app/chunks/vendor-18fa7eb7.js"]
    },
    fetched: void 0,
    floc: false,
...
${$Layout.menu ? `${validate_component(Menu, "Menu").$$render($$result, {}, {}, {})}` : `<div><h1 class="${"font-bold text-6xl mb-4"}">${escape(title2)}</h1>
    <p>This is our team.</p>
    <div class="${"post svelte-5dgm73"}">${slots.default ? slots.default({}) : ``}</div>
    <div>${each(members, (member, index2) => `${validate_component(Member, "Member").$$render($$result, { member: member.metadata }, {}, {})}`)}</div></div>`}`;
});
